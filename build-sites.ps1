...
Copy-Item -LiteralPath (Join-Path $project 'home') -Destination (Join-Path $dist 'client/home') -Recurse
...
foreach ($file in Get-ChildItem -LiteralPath $site -File) {
  if ($file.Extension -eq '.html') {
    ...
    $content = $content -replace 'href="\.\./home/index\.html"', 'href="index.html"'
